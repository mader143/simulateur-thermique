...
ax3D.set_zlim(T_init - 273 - 1, T_init - 273 + 15)
...
print(f"Speed factor: {t_simulation/elapsed:.1f}x real-time")
...
ax3D.set_title(f"Température finale – t = {t_simulation:.2f} s")
fig3D.canvas.draw()
